...
"""CURRENCY_PAIRS = [
	...
	{ 'name': 'Bitcoin / Australian Dollars', 'symbols': ('btc','aud') },
	{ 'name': 'Bitcoin / Swiss Francs', 'symbols': ('btc','chf') },
	{ 'name': 'Bitcoin / Danish Kroner', 'symbols': ('btc','dkk') },
	{ 'name': 'Bitcoin / British Pounds', 'symbols': ('btc','gbp') },
...
RESOURCES = {
	"column_1": [
		...
		},
		{
			...
			"items": [
				{
				"name": "bitcoinmining.com",
				"url": "http://www.bitcoinmining.com/",
				"description": ""
				},
				{
				"name": "CoinWarz Cryptocurrency Profitability Comparison",
				"url": "http://www.coinwarz.com/cryptocurrency",
				"description": ""
				},
				{
				"name": "BitcoinX Bitcoin Profitability Calculator",
				"url": "http://www.bitcoinx.com/profit/",
				"description": ""
				},
			],
		},
